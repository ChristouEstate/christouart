...
1. Upload `index.html`, `CNAME`, and `hero_christou.jpg` to your GitHub repository.
2. Enable GitHub Pages in Settings → Pages.
3. Set your custom domain to `christou.art`.

© 2025 Christou Estate. All rights reserved.
